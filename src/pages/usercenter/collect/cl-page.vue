<template>
  <div class="mc">
    <div class="left-nav">
      ...
      <router-link to="/usercenter/collect/database" class="nav-lan">收藏的数据库</router-link>
      <router-link to="/usercenter/collect/page" class="nav-lan nav-lan-active">收藏的页面&nbsp;&nbsp;></router-link>
    ...
    <div class="right-view">
      <div class="section">
        <div class="head">
          <div class="title"><i class="iconfont">&#xe757;</i><span>收藏的页面</span></div>
        </div>
        <!-- PART:收藏的页面(无) -->
          ...
          <el-table
            ...
            v-for="item in tableHead"
              ...
              <template slot-scope="scope">
                <div v-if="item.prop === 'biaoti'">
                  <router-link tag="span" :to="scope.row.url">
                    {{ scope.row.title }} - {{ scope.row.label }}
                  </router-link>
                </div>
                ...
                <div v-if="item.prop === 'caozuo'">
                  <el-button type="primary" round size="mini">
                    <router-link tag="span" :to="scope.row.url">查看</router-link>
                  </el-button>
...
const defaultFiled = tableHead.usercenter.sc_ym
export default {
  data() {
    return {
      data: {},
