<template>
  <div class="mc">
    <div class="left-nav">
      ...
      <router-link to="/usercenter/collect/company" class="nav-lan nav-lan-active">收藏的企业&nbsp;&nbsp;></router-link>
    </div>
    <!--  -->
    <div class="right-view">
      <div class="section">
        <div class="head">
          <div class="title"><i class="iconfont">&#xe757;</i><span>收藏的企业</span></div>
        </div>
        <!-- PART:收藏的企业(无) -->
...
const defaultFiled = tableHead.usercenter.sc_qy
export default {
  data() {
    return {
      data: {},
