...
export default {
  ...
  methods: {
    ...
    worldConfigure(worldData) {
      ...
      console.log(max);
      let myChart = Echarts.init(document.getElementById("gjfbChina"), "westeros");
      myChart.setOption({
        toolbox: {
          top: 20,
          right: 20,
    ...
    cplbChinaConfigure(cplbChinaData) {
      ...
      if (_len > 0) {
        ...
        let myChart = Echarts.init(document.getElementById("cplbChina"), "westeros");
        myChart.setOption({
          legend: {
            type: "scroll",
            bottom: 0,
    ...
    yplxChinaConfigure(cplbChinaData) {
      ...
      if (_len > 0) {
        ...
        let myChart = Echarts.init(document.getElementById("yplxChina"), "westeros");
        myChart.setOption({
          legend: {
            type: "scroll",
            bottom: 0,
    ...
    xmjdChinaConfigure(data) {
      ...
      let myChart = Echarts.init(document.getElementById("xmjdChina"), "westeros");
      myChart.setOption({
        tooltip: {
          trigger: "item",
          axisPointer: {
    ...
    zllyChinaConfigure(data) {
      ...
      let myChart = Echarts.init(document.getElementById("zllyChina"), "westeros");
      myChart.setOption({
        legend: {
          type: "scroll",
          top: 0,
