<template>
  <div class="timeline">
    <div class="part-title">药品时光轴</div>
        ...
        <div class="item" v-for="(item, index2) in row" :key="index2">
          ...
          <div class="con">
            ...
            <div class="bd" v-if="item.type == 'news'">
              <a class="text" v-text="item.title" target="_blank"></a>
            </div>
      ...
      Axios({
        ...
        .then((res) => {
          if ((res.data.code = 200)) {
            this.sglst = this.arrTrans(7, res.data.data.list.slice(0, 5));
            if (this.sglst.length == 0) {
              this.$root.$emit("hide-page", "药品时光轴");
            }
          } else {
            this.$root.$emit("hide-page", "药品时光轴");
          }
        ...
        .finally(() => {
          this.$root.$emit("load-page", "药品时光轴");
        })
        ;
    },
  },
