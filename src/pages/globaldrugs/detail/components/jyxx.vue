        ...
        >
          <template slot-scope="scope">
              ...
              <div>
                ...
                <div>
                  ...
                  <span
                    ...
                    "
                    v-if="scope.row.targets_abbr || scope.row.targets"
                    >靶点:{{
                      scope.row.targets_abbr || scope.row.targets
                    }}</span
                  >
            ...
            <template v-else-if="item.prop === 'guifan_therapeuticarea'">
              <div 
              class="overflow"
              v-if="scope.row.therapeuticarea.length > 0">
              <el-popover placement="right" width="250" trigger="hover">
                <div>
                  {{ scope.row.therapeuticarea.join(",") }}
                </div>
                <div slot="reference"> {{ scope.row.therapeuticarea.join(",") }}</div>
              </el-popover>
            ...
            <template v-else-if="item.prop === 'guifan_cooperationtype'">
              ...
              <p
                class="hzlx text2line"
                :title="'权益类型:' + scope.row.guifan_quanyileixing"
...
export default {
  ...
  watch: {
    ...
    //   async handler(val) {
    //     if (val) {
    //       this.targets = this.base.targets_abbr
    //         ? this.base.targets_abbr
    //         : this.base.targets;
