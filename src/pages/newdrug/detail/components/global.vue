  ...
  <div class="table-ul">
    ...
    <div>
      ...
      >
        ...
        <li>{{ item.ypxs.value ? item.ypxs.value : "/" }}</li>
        <li>
          <span :title="item.originatorcompany_02">{{
            item.originatorcompany_02 ? item.originatorcompany_02 : "/"
          }}</span>
        </li>
      </ul>
    </div>
