<template>
  <div class="la-header" v-if="path.indexOf('/login') !== 0">
            ...
            <form class="c-search-form" @submit.prevent="onSubmit">
              <el-select class="comprehensive" v-model="searchCategory" popper-class="header-elselect"
                ...
                <el-option v-for="(sc, index) in searchCategorys"
                  :label="$t('cSearch.searchCategorys.' + sc + '.label')" :value="sc" :key="index"></el-option>
              </el-select>
    ...
    getNavData() {
      ...
      window
        ...
        .then((res) => {
          ...
          Store.commit('UserCenter/menuList', this.menuList)
