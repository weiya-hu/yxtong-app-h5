<template>
  <div class="la-header-policies" v-if="path.indexOf('/login') !== 0">
      ...
      <div :class="$route.path != '/home' ? 'right' : 'right2'">
        <nav class="la-header-nav">
          <div @mouseover="mouseOver" class="header-nav-item" :class="{
            ...
            'hover-sc':
              item.shortlabel == '研发' && firstShowGlobaldrugsNav == '1',
            'hover-sc':
        ...
        <div class="header-right">
          ...
          <div v-if="$route.path !== '/home'" class="search-form-box">
            <form class="c-search-form" @submit.prevent="onSubmit">
              ...
              <a id="header-search-btn" class="header-search-btn" @click="handleSearchClick">
                <img src="/static/imgs/policies/search.png" alt="" />
              </a>
