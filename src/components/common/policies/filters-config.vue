                ...
                >
                  <template slot="title">
                    ...
                    >
                      ...
                      ></div>
                      <img
                        src="../../../assets/imgs/policy/proplem.png"
                        alt=""
                        width="14"
                  ...
                  >
                    ...
                    <div class="trees">
                      <el-tree
                        ...
                        "
                        :ref="'tree2' + index"
                        :check-strictly="key !== 'validity_type_cn'"
                      >
                        <span
...
export default {
  ...
  methods: {
    ...
    checkGA(key, data, index, checkTree) {
      ...
      window.ga("send", "event", "option", "click", "企业版_政策法规_条件筛选");
      window._paq.push([
        "trackEvent",
        "option",
        "click",
  ...
  watch: {
    ...
    searchLoading(val) {
      if (!val) {
        this.defaultExpanded2 = this.checked["validity_type_cn"];
      }
    },
  },
  updated() {
  ...
  mounted() {
    console.log(this.filters);
    this.activeNames = ["validity_type_cn"];
  },
};
</script>
