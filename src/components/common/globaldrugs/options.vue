<template>
  <div
    class="la-optioned clearfix globaldrugs-optioned"
    :class="{
    ...
    >
      ...
      >
        ...
        <span class="btn option">
          ...
          <img src="~@/assets/imgs/globaldrugs/option_icon.png" width="12" class="icon-close" @click="handleFourthCloseClick()"/>
        </span>
      </span>
      <!-- 普通搜索 -->
      <span
      ...
      >
        ...
        <span class="btn option">
          ...
          <img
            src="~@/assets/imgs/globaldrugs/option_icon.png"
            class="icon-close"
            width="12"
      ...
      <!-- 全球药物高级搜索中的条件筛选 -->
      <span
        v-for="(option, index) in storeState.conditionsFilter
          ? storeState.conditionsFilter
          : []"
        :key="index"
        v-if="
          (option.value
      ...
      >
        ...
        >
          <span class="btn option">
            ...
            >
            <img src="~@/assets/imgs/globaldrugs/option_icon.png" width="12" class="icon-close" @click="handleHotCloseClick"/>
          </span>
        </span>
      </div>
      ...
      >
        <span class="btn option">
          ...
          <img src="~@/assets/imgs/globaldrugs/option_icon.png" width="12" class="icon-close" @click="handleSourceCloseClick"/>
        </span>
      </div>
      <!-- 保存 & 清空 -->
      <div
...
/* 已选条件 - 样式 start */
.la-optioned.globaldrugs-optioned {
