<template>
  <div class="la-input">
    <div class="title">
      ...
      <!-- <el-tooltip
        v-if="initItem.statement && this.vuex_name == 'Globaldrugs'"
        effect="light"
        placement="right"
      >
        <div slot="content" v-html="initItem.statement"></div>
    ...
    <inputPopover :value="value" :accurate="accurateValue">
      ...
      <el-autocomplete
        ...
        :title="(item.placeholder + '').length > 10 ? item.placeholder : ''"
    ...
    querySearchAsync(queryString, callback) {
      ...
      var param = Qs.parse(
        this.initItem.name +
          ...
          queryString.slice(
            0,
            this.accurateValue ? this.inpMaxLenJq : this.inpMaxLen
          )
      ); //解决参数键值不能为变量
      let _queryString = "";
      if (
