<template>
  <div class="la-auto-select">
    ...
    <el-select id="nameAnalyWords" v-model="value" :remote-method="remoteMethod" :loading="loading" filterable remote
      clearable :reserve-keyword="false" :placeholder="initItem.placeholder" @change="resetValue"
      @click.native="nameSelChange" @clear="clearSelFn" :no-data-text="'无数据'" @keyup.native.enter="getEnterKey()">
