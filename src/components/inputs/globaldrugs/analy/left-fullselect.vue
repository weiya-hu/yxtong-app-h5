<template>
  <div class="la-fullselect">
    <div class="title">
      <div class="flex">
        <label class="title-label">
          <NewProjectGuide :onlyKey="item['new_id']" :newPosition="{ right: item.statement ? -40 : -26 }"
    ...
    <el-cascader v-model="value" class="la-advenced-fullselect" :placeholder="item.placeholder" :options="options"
      :props="cascaderConfig" @change="updateValue" separator=">" filterable change-on-select clearable
      ref="popoverCascader"></el-cascader>
  </div>
</template>
<script>
export default {
