<template>
  <div class="la-date">
    ...
    <div class="date-range">
      <el-date-picker type="month" v-model="dateval[0]" @change="update(1)" placeholder="选择年月" size="mini"
        format="yyyy-MM" value-format="yyyyMM" clearable :picker-options="pickerOptionsStart" ref="popoverStart">
      </el-date-picker>
      <span>-</span>
      <el-date-picker type="month" v-model="dateval[1]" @change="update(1)" placeholder="选择年月" size="mini"
        format="yyyy-MM" value-format="yyyyMM" clearable :picker-options="pickerOptionsEnd" ref="popoverEnd">
      </el-date-picker>
    </div>
  </div>
</template>
